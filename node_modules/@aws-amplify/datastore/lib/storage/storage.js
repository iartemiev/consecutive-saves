...
var StorageClass = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        result.forEach(function (r) {
                            ...
                            var updateWithPatches = opType === types_1.OpType.UPDATE && patches && patches.length;
                            var element = updateWithPatches
                                ? _this.getUpdateMutationInput(model, originalElement, patches)
                                : originalElement;
    ...
    StorageClass.prototype.getUpdateMutationInput = function (model, originalElement, patches) {
        var updatedElement = {};
